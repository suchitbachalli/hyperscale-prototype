...
export const meetingNotes: MeetingNote[] = [
  {
    ...
    summary: [
      ...
      'Dave provided service account credentials for API access',
    ...
    extractedData: {
      ...
      'Live URL': 'example-erp-api.example.com',
      'Play URL': 'example-erp-play.example.com',
      'Order Statuses': 'BAL, COD, HOLD, NO LIMIT',
      'Pricing Model': 'One contract per customer',
      'DB Names': 'example_db_live, example_db_play',
    },
